...
class EmailConnector(QObject):
    ...
    def __init__(self, invoice_retrieval_window):
        ...
        self.invoice_retrieval_window = invoice_retrieval_window
        self.email = ""
        self.password = ""
        self.imap_server = ""

        file_imap_servers = os.path.join(self.root_directory, 'json', 'imap_servers.json')
        self.all_imap_servers = self.load_imap_servers(file_imap_servers)
    ...
    def set_imap_server(self, provider: str):
        """Set IMAP server."""
        self.imap_server = self.all_imap_servers[provider]
    ...
    def load_imap_servers(self, filename):
        with open(filename, 'r') as file:
            all_imap_servers = json.load(file)
        return all_imap_servers
