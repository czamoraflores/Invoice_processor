...
class InvoiceExtractor:
    ...
    def extract_data_from_file(self, n_request, file_path):
        ...
        n_request, headeri_data, detaili_data, headero_data, detailo_data, all_info = self.openai_connector.extract_data(n_request, email_subject, email_body, email_content)
        return n_request, headeri_data, detaili_data, headero_data, detailo_data, all_info
